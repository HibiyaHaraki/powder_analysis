function [velocity_fluctuation_acceleration,velocity_fluctuation_constVelocity,real_x,real_y] = compute_velocity_u_fluctuation(search_x,search_y,characteristicVelocity_acceleration,characteristicVelocity_constVelocity,PIV_data_filename,Truck_data_filename)
    %% Explanation
    
    %
    % compute_velocity_u_fluctuation
    %
    ...
    if (~isnan(characteristicVelocity_constVelocity))
        ...
        constVelocity_stop = length(PIV_data.meanMap_u_filtered);
        %{
